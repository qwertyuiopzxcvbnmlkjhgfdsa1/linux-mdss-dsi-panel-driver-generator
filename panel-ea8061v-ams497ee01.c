...
static int ea8061v_ams497ee01_on(struct ea8061v_ams497ee01 *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0xca, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00, 0x00);
...
static int ea8061v_ams497ee01_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx->panel.dev = dev;
	ctx->panel.funcs = &ea8061v_ams497ee01_panel_funcs;
...
static const struct of_device_id ea8061v_ams497ee01_of_match[] = {
	{ .compatible = "mdss,ea8061v_ams497ee01" }, // FIXME
	{ }
};
