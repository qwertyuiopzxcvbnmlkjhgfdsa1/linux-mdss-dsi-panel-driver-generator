...
static int s6e88a0_ams452ef01_on(struct s6e88a0_ams452ef01 *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0xca, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x6b, 0x68, 0x71, 0x00, 0x00, 0x00);
	dsi_dcs_write_seq(dsi, 0xb2, 0x40, 0x0a, 0x17, 0x00, 0x0a);
	dsi_dcs_write_seq(dsi, 0xb6, 0x2c, 0x0b);
...
static int s6e88a0_ams452ef01_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx->panel.dev = dev;
	ctx->panel.funcs = &s6e88a0_ams452ef01_panel_funcs;
...
static const struct of_device_id s6e88a0_ams452ef01_of_match[] = {
	{ .compatible = "mdss,s6e88a0_ams452ef01" }, // FIXME
	{ }
};
...
MODULE_DESCRIPTION("DRM driver for ss_dsi_panel_S6E88A0_AMS452EF01_QHD");
